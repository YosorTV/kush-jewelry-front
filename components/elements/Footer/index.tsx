...
export const Footer: FC<FooterProps> = ({ data, locale }) => {
  return (
    <footer className='footer relative flex min-h-16 w-full border-t border-info-content bg-base-100 px-5 py-6 drop-shadow-md'>
      <div className='grid w-full grid-cols-1 gap-x-20 gap-y-3 md:gap-y-6 lg:grid-cols-4'>
        ...
        <nav className='flex w-full flex-col items-center gap-y-6 lg:items-start'>
        ...
        <nav className='flex w-full flex-col items-center md:items-start'>
          <address className='flex w-full flex-col items-center gap-y-3 not-italic lg:items-start'>
            <Title level='4' className='hidden md:block'>
            ...
            <ul className='flex flex-col items-center justify-center gap-x-6 font-medium text-base-200 lg:items-start lg:justify-start'>
              <li className='py-3 text-center sm:whitespace-nowrap md:text-left lg:max-w-56'>
                <span>{data.address}</span>
              </li>
              <li className='flex flex-wrap justify-center gap-x-6 gap-y-3 py-3'>
        ...
        <nav className='flex w-full flex-col items-center gap-y-3 lg:items-start'>
          <Title level='4' className='hidden md:block'>
